...
import (
	...
	"github.com/kytnacode/go-jrpc/params"
)
...
func TestParseParams_ValidParams(t *testing.T) {
	...
	for name, data := range testData {
		t.Run(name, func(t *testing.T) {
			got, err := params.ParseParams[args](data.params)
			if err != nil {
...
func TestParseParams_InvalidParams(t *testing.T) {
	...
	for name, data := range testData {
		t.Run(name, func(t *testing.T) {
			_, err := params.ParseParams[args](data.params)
			if err == nil {
...
func TestParseParamsType_InvalidType(t *testing.T) {
	...
	for name, data := range testData {
		t.Run(name, func(t *testing.T) {
			_, err := params.ParseParamsType(data.t, in)
			if err == nil {
				t.Error("expected error, got nil")
			}
		})
...
func TestParseParamsType_ValidParams(t *testing.T) {
	...
	for name, data := range testData {
		t.Run(name, func(t *testing.T) {
			got, err := params.ParseParamsType(data.t, data.params)
			if err != nil {
				t.Errorf("unexpected error: %v", err)
			}
...
func TestParseParamsType_InvalidParams(t *testing.T) {
	...
	for name, data := range testData {
		t.Run(name, func(t *testing.T) {
			_, err := params.ParseParamsType(data.t, data.params)
			if err == nil {
				t.Error("expected error, got nil")
			}
		})
